...
namespace Enfonica.Api.Auth.OAuth2
{
    ...
    internal static class TokenResponseExtensions
    {
        ...
        internal static bool IsEffectivelyExpired(this TokenResponse tokenResponse, IClock clock) =>
            (tokenResponse.AccessToken == null && tokenResponse.IdToken == null) ||
            !tokenResponse.ExpiresInSeconds.HasValue ||
            tokenResponse.IssuedUtc.AddSeconds(tokenResponse.ExpiresInSeconds.Value - TokenHardExpiryTimeWindowSeconds) <= clock.UtcNow;
    }
}
